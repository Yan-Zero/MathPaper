...
\begin{enumerate}[itemsep=-0.3em,topsep=0pt]
  ...
  \item 某次体检，6位同学的身高（单位：米）分别为1.72，1.78，1.75，1.80，1.69，1.77则这组数据的中位数是\blank{$1.76$}（米）.
  ...
  \item 在$\displaystyle{\left (\sqrt[3]{x}-\frac{3}{x}\right )^n}$的二项式中，所有项的二项式系数之和为256，则常数项等于\blank{262}.
